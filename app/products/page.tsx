...
export const metadata: Metadata = {
  title: "Products",
  description:
    "Browse Verawood's full range of European White Oak boards — fifteen finishes from pale Lume to smoked Fumo, engineered for stability and finished by hand.",
  alternates: { canonical: `${SITE_URL}/products` },
  openGraph: {
    title: "Products — VERAWOOD Hardwood Flooring",
    description: "Fifteen European White Oak finishes, engineered for stability and finished by hand.",
    ...
    <>
      ...
      <section className="section collections" id="products" aria-labelledby="products-heading">
        <div className="shell">
          <SectionHeader
            eyebrow="The Range"
            title="Fifteen finishes, one standard."
            linkHref="/samples"
